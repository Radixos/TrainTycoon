...
namespace UnityEngine.GameFoundation
{
    public class SpriteAssetsDetailDefinition : BaseDetailDefinition
    {
        ...
        /// </summary>
        /// <param name="key">The Sprite we are searching for</param>
        /// <returns>Returns a Sprite if one is found with that key. Could return null. Could throw a KeyNotFoundException.</returns>
        public Sprite this[string key] => GetAsset(key);
        ...
        /// Note: this returns the current state of keys for this detail definition.
        ...
        /// </summary>
        /// <param name="list">The list to clear and fill with updated key data.</param>
